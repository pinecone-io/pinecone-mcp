...
server.tool(
  'upsert',
  'Insert or update text data in a Pinecone index',
  {
    ...
    data: z.array(
      z.object({
        ...
        metadata: z
          .record(
            z.string().describe('The key of the metadata field'),
            z.string().describe('The value of the metadata field'),
          )
...
server.tool(
  'search',
  'Search an namespace for records that are similar to the query text',
  {
