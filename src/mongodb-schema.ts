...
const FieldFilter = z.record(
  z.string().describe('The metadata field to filter on'),
  z.union([ScalarValue, FieldOperator]).describe('The value to compare the field to'),
).describe('Filters records based on the value of a metadata field');
